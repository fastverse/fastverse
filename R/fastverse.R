#' The \emph{fastverse}: A Suite of High-Performance Packages for Statistical Computing and Data Manipulation in R
#' 
#' @description
...
#' with \code{library(fastverse)}. Further functions help with sorting out namespace conflicts between attached packages, and updating packages.  
#' 
#' @details NULL
