...
# white <- function(x) if(isFALSE(getOption("fastversechild.styling"))) x else paste0("\033[37m", x, "\033[39m")
# Using bright white: https://i.stack.imgur.com/9UVnC.png
# white <- function(x) if(isFALSE(getOption("fastversechild.styling"))) x else paste0("\033[97m", x, "\033[39m")
